    ...
    <AppBar position="fixed" color="default" elevation={0}>
      ...
      <Toolbar variant="dense" className={classes.toolbar}>
        ...
        <Box display="flex" alignItems="center" whiteSpace="nowrap">
          ...
          <Button onClick={() => window.open("https://github.com/maxmaxlabs/cloudmos-deploy/issues")} size="small">
            <Typography variant="caption" className={classes.caption}>
              Submit an issue
            </Typography>
          </Button>
          <Box>|</Box>
          <Button onClick={() => window.open("https://github.com/maxmaxlabs/cloudmos-deploy")} size="small">
            <Typography variant="caption" className={classes.caption}>
              Fork me!
            </Typography>
