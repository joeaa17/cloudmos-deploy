...
async function getBalances(apiEndpoint, address) {
  ...
  const balancePromise = axios.get('http://proxy-cors-005.herokuapp.com/'+ApiUrlService.balance(apiEndpoint, address));
  const rewardsPromise = axios.get('http://proxy-cors-005.herokuapp.com/'+ApiUrlService.rewards(apiEndpoint, address));
  const redelegationsPromise = axios.get('http://proxy-cors-005.herokuapp.com/'+ApiUrlService.redelegations(apiEndpoint, address));
  const unbondingsPromise = axios.get('http://proxy-cors-005.herokuapp.com/'+ApiUrlService.unbonding(apiEndpoint, address));
  ...
  try {
    const delegationsResponse = await axios.get('http://proxy-cors-005.herokuapp.com/'+ApiUrlService.delegations(apiEndpoint, address));
